    ...
    >
      <div className="mx-auto max-w-7xl flex items-center justify-between px-6 md:px-12 h-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={toggleMenu}
            className="relative z-50 flex lg:hidden h-10 w-10 flex-col items-center justify-center gap-1.5 cursor-pointer"
      ...
      <div
        className={cn(
          "fixed inset-0 z-40 flex lg:hidden flex-col items-center justify-center bg-bg/98 backdrop-blur-xl transition-all duration-300",
